...
sub deploy_software {
	...
	execute_remote_command_in_screen_and_wait($ssh, $remote, 'deploymodules', 5 , "sudo curl https://raw.githubusercontent.com/wgerlach/USAGEPOD/master/lib/USAGEPOD.pm > /usr/share/perl5/USAGEPOD.pm");
